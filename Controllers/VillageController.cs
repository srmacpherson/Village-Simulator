...
public class VillageController(ApplicationDbContext db, ResourceService resourceService) : Controller
{
    private readonly ApplicationDbContext _db = db;
    private readonly ResourceService _resourceService = resourceService;
    public IActionResult Index()
    {
        Village village = _db.Villages
        ...
        var model = new VillageViewModel
        {
            ...
            WarehouseLevel = village.WarehouseLevel.ToString()
        };
    ...
    public IActionResult Queue()
    {
        ...
        var msg = TempData != null
            ...
            return Json(new
            {
                ...
                clay = village.Clay,
                iron = village.Iron,
                woodCapacity = village.WoodCapacity,
                clayCapacity = village.ClayCapacity,
                ironCapacity = village.IronCapacity
            });
    }
